        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="开户类型" prop="AccountOpenType">
              <el-select v-model="EnterpriseManage.AccountOpenType" class="rangeTimeClass" filterable placeholder="开户类型">
                <el-option v-for="item in AccountOpenTypeArray" :key="item.ConfigValue" :label="item.ConfigName"
          ...
          <el-col :span="8">
            <el-form-item label="收款账户" prop="CollectionAccount">
              <el-input v-model="EnterpriseManage.CollectionAccount" placeholder="收款账户" clearable @input="GetBank" />
            </el-form-item>
          </el-col>
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="所在地区" prop="LocationRegion">
              <el-cascader v-model="EnterpriseManage.LocationRegion" class="rangeTimeClass" :options="options" clearable
                filterable @change="handleChange" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="详细地址" prop="DetailedAddress">
              <el-input v-model="EnterpriseManage.DetailedAddress" type="textarea" :autosize="{ minRows: 2, maxRows: 4 }"
                placeholder="详细地址" clearable />
            </el-form-item>
          </el-col>
        </el-row>
      </el-card>
