<template>
  <div style="margin:8px">
    ...
    <el-tabs v-model="ActiveName" class="CardTableClass" type="border-card" @tab-click="handleClick">
    ...
    >
            ...
            <el-statistic :title="OrderDetailMoney.title1">
              <template slot="prefix">
                <div v-if="!BlankSum">
                  ...
                  <span v-format="'#,##0.00'" class="MoneySpanClass">{{ OrderDetailMoney.AllMoney
                  }}</span>
                </div>
            ...
            <el-statistic :title="OrderDetailMoney.title2">
              <template slot="prefix">
                <div v-if="!BlankSum">
                  ...
                  <span v-format="'#,##0.00'" class="MoneySpanClass">{{ OrderDetailMoney.AddMoney
                  }}</span>
                </div>
                <div v-else class="MoneySpanClass">暂无</div>
            ...
            <el-statistic :title="OrderDetailMoney.title3">
              <template slot="prefix">
                <div v-if="!BlankSum">
                  ...
                  <span v-format="'#,##0.00'" class="MoneySpanClass">{{ OrderDetailMoney.DeleteMoney
                  }}</span>
                </div>
                <div v-else class="MoneySpanClass">暂无</div>
              </template>
      ...
      <el-tabs v-model="ActiveDetailName" class="CardTableClass" @tab-click="handleDetailClick">
        <el-form label-width="80px">
          <el-row>
            <el-col :span="8">
              <el-form-item label="姓名" class="whereDetailClass">
                <el-input v-model="WhereParameter.StaffName" clearable placeholder="姓名" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
