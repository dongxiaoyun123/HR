  ...
  <div style="margin:8px">
    ...
    <el-card class="CardTableClass">
      <el-table v-loading="loading" highlight-current-row :data="ContractorList" fit>
        <el-table-column prop="ParentName" label="合同方" min-width="150" show-overflow-tooltip />
        <el-table-column prop="EnterPriseName" label="付款方" min-width="150" show-overflow-tooltip />
    ...
    >
      ...
      <el-form ref="addStaffRef" :model="AddContractorForm" :rules="addContractorRules" label-width="120px">
        <el-alert v-if="IfUpdate" style="margin-bottom:20px ;" type="warning" show-icon
        ...
        <el-form-item label="合同方" prop="ParentCode">
          <el-select v-model="AddContractorForm.ParentCode" filterable placeholder="合同方"
                     :disabled="IfUpdate" @change="ParentCodeChange"
          >
        ...
        <el-form-item label="付款方" prop="EnterPriseName">
          <el-input v-model="AddContractorForm.EnterPriseName" placeholder="付款方" :disabled="IfUpdate" />
        </el-form-item>
        ...
        <el-form-item label="排序" prop="OrderBy">
          <el-input-number v-model="AddContractorForm.OrderBy" :min="1" />
        </el-form-item>
        <el-divider />
