    ...
    <div style="margin:8px">
        ...
        <el-card class="CardTableClass">
            <el-table v-loading="loading" highlight-current-row :data="SynchronizationList" fit>
                <el-table-column prop="ParentName" label="合同方" width="250" show-overflow-tooltip></el-table-column>
                <el-table-column prop="EnterPriseName" label="付款方" width="250" show-overflow-tooltip></el-table-column>
        ...
        <!-- 添加同步信息 -->
        <el-dialog :visible.sync="addSynchronizationVisible" top="5vh" width="45%" @close="detailAddDialogVisibleClosed"
            :lock-scroll="false" :append-to-body="true">
            <!-- 上面两个属性用来重置滚动条 -->
            <div slot="title" class="dialog-title">
                <span>添加同步信息</span>
            </div>
            <el-form :model="AddSynchronizationForm" ref="addSynchronizationRef" :rules="addSynchronizationRules"
                label-width="120px">
                ...
                <el-form-item label="付款方" prop="EnterPriseCode">
                    <el-select style="width:100%" v-model="AddSynchronizationForm.EnterPriseCode" filterable
