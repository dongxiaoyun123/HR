<template>
  <div style="margin:8px">
          ...
          <el-row>
            ...
            <el-col :span="6">
              <el-form-item style="margin-bottom: 0;" label="合同方">
                <el-input v-model="WhereParameter.EnterPriseName" clearable placeholder="合同方" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
    ...
    <el-card class="CardTableClass">
      <el-table ref="multipleTable" v-loading="loading" highlight-current-row :data="LoginLogList" fit>
        <el-table-column prop="EnterPriseName" label="公司名称" min-width="140" show-overflow-tooltip />
