...
import { GenderAgeStatisticsData } from "@/api/hrstatistics";
        ...
        series: [
          {
            ...
            radius: ["35%", "50%"],
            data: [
              { value: this.ChartData.GetCropTypeGData.P0, name: "男" },
              { value: this.ChartData.GetCropTypeGData.P1, name: "女" },
            ],
            itemStyle: {
              emphasis: {
                shadowBlur: 10,
        ...
        series: [
          {
            ...
            data: [
              {
                value: this.ChartData.GetCropTypeYData.peoplecount0,
                name: "20岁以下",
              },
              {
                value: this.ChartData.GetCropTypeYData.peoplecount1,
                name: "20-25岁",
              },
              {
                value: this.ChartData.GetCropTypeYData.peoplecount2,
                name: "25-30岁",
              },
              {
                value: this.ChartData.GetCropTypeYData.peoplecount3,
                name: "30-35岁",
              },
              {
                value: this.ChartData.GetCropTypeYData.peoplecount4,
                name: "35-40岁",
              },
              {
                value: this.ChartData.GetCropTypeYData.peoplecount5,
                name: "40岁及以上",
              },
            ],
            itemStyle: {
